    ...
    return (
        <div>
            ...
            <div className="relative">
                ...
                <video className="h-[500px] w-full object-cover " muted loop autoPlay src="https://cdn.shopify.com/videos/c/o/v/841e1f13d0d642808376df8122525e3b.mp4">
                </video>
                ...
                <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
                    ...
                    <Link href="/sales?gender=men" className="flex m-4 justify-evenly  w-[500px]">
                        <div className="border border-4 font-medium text-black border-white bg-white py-2 px-12  text-center">Shop Now</div>
                    </Link>
                </div>
            ...
            <div className='h-[600px]'>
                ...
                <div className=' flex justify-evenly' >
                    ...
                    <Link href="/sales?gender=men&type=pants">
                        <img src="sales/pants1.webp" className='cursor-pointer h-[400px] w-[300px] object-cover  ' alt="" />
                        <h4 className=' font-semibold'>Pants</h4>

                    </Link>

                    <Link href="/sales?gender=men&type=top">
                        <img src="sales/top1.webp" className='cursor-pointer h-[400px] w-[300px] object-cover  ' alt="" />
            ...
            <div className=' h-[600px]'>
                ...
                <div className='flex justify-evenly'>
                    ...
                    {newProducts
                        ...
                        .slice(currentSlide, currentSlide + itemsPerPage).map(product => (
                    ...
                    <div className='flex flex-col justify-center items-center  w-full'>
                        ...
                        <div className=' w-[400px] flex justify-between p-2 m-2'>
                            ...
                            {newProducts.length > 0 ? (
                                ...
                                newProducts.filter(product => product.gender === 'men' && product.type === 'sweaters')
                                    .slice(currentSlide, currentSlide + brrItemsPerPage).map(product => (
                        ...
                        <div className='text-lg font-semibold underline'><Link href="/sales?gender=men&type=sweaters">Shop Now
                        </Link></div>
                    </div>
                </div>
